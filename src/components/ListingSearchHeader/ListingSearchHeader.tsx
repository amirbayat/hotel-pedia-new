...
import { IconArrowDown, IconCallCenter, IconDate, IconLogin, IconSearch } from '../icons'
    ...
    <header className={styles.header}>
      <div className={styles.inner}>
        <div className={styles.fields}>
          <Button variant="primary" icon={IconSearch} onClick={onSearch} aria-label="جستجو" />
          ...
          <div className={styles.dateField} ref={dateFieldRef} onClick={() => setIsCalendarOpen(true)}>
            ...
            {isCalendarOpen && (
              <DateRangeCalendar className={styles.calendarPopover} value={dateRange} onChange={onDateRangeChange} />
            )}
          </div>
        ...
        <div className={styles.right}>
          ...
          {user ? (
            ...
            <Button variant="secondary" icon={IconLogin} onClick={() => setAuthOpen(true)}>
              ورود - ثبت نام
            </Button>
          )}
